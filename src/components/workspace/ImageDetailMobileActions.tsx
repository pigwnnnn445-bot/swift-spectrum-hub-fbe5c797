...
const ImageDetailMobileActions = ({ imageUrl, onRegenerate, onDelete }: ImageDetailMobileActionsProps) => {
  ...
  return (
    <div className="flex items-center justify-center gap-3 px-4 py-2 border-t border-workspace-border/40 shrink-0 lg:hidden">
