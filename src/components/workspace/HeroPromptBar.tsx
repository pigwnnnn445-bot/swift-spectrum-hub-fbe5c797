      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 py-12 sm:py-16">
        ...
        <div className="relative w-full max-w-[760px]">
          <div className="flex items-end rounded-2xl border border-workspace-border/60 bg-workspace-surface shadow-lg">
            ...
            />
            <button disabled={!prompt.trim()} className="mr-2 mb-2 flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-primary to-workspace-neon px-5 py-2.5 text-sm font-medium text-white transition-all hover:brightness-110 shadow-md shrink-0 disabled:pointer-events-none">
              发送
